          ...
          <div className="mx-auto max-w-4xl px-5 text-center md:px-10">
            ...
            <Reveal delay={0.2}>
              <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-ash">
                Официальный мерч клуба появится на следующем этапе развития платформы. Сначала сайт закрывает главные задачи клуба: бренд, состав, матчи, новости, медиа и партнерство.
              </p>
            </Reveal>
            <Reveal delay={0.3}>

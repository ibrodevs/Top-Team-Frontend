  ...
  return (
    <SiteShell>
      <article className="min-h-screen bg-ink pt-16 md:pt-20">
        <section className="relative min-h-[420px] h-[60vh] overflow-hidden">
          ...
          <div className="relative mx-auto flex h-full max-w-4xl flex-col justify-end px-5 pb-12 md:px-10 md:pb-20">
            ...
            <div className="mt-6 flex items-center gap-5 text-sm text-ash">
        ...
        <section className="py-16 md:py-24">
          <div className="mx-auto max-w-3xl px-5 md:px-10">
            ...
            <Reveal><div className="article-body"><ReactMarkdown>{article.body || "Текст статьи скоро появится."}</ReactMarkdown></div></Reveal>
          </div>
        </section>
      </article>
    </SiteShell>

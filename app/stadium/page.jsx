          ...
          <div className="mx-auto max-w-4xl px-5 text-center md:px-10">
            ...
            <Reveal delay={0.2}>
              <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-ash">
                Раздел откроется, когда клуб подтвердит официальную домашнюю площадку. Мы принципиально не публикуем непроверенные адреса и карты — только реальную информацию.
              </p>
            </Reveal>
            <Reveal delay={0.3}>

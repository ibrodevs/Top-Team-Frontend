      ...
      <div className="min-h-screen bg-ink pt-20 md:pt-24">
        <section className="py-16 md:py-24">
          <div className="mx-auto max-w-4xl px-5 text-center md:px-10">
            ...
            <SplitTitle text="Локация клуба еще не подтверждена" as="h1" className="text-display mt-3 text-[clamp(2.5rem,8vw,6rem)] text-white" />
            <Reveal delay={0.2}>
              <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-ash">
                В документе отдельно отмечено, что не стоит публиковать фейковый стадион или карту, пока клуб не подтвердит реальную площадку, базу или офис. Поэтому этот раздел сознательно убран из первой версии.
              </p>
            </Reveal>
            <Reveal delay={0.3}>
